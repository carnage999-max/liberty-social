...
export default function FeedPage() {
  ...
  return (
    <RequireAuth>
      <section className="min-h-screen bg-[var(--color-background)] pb-12 pt-20 sm:pt-24 lg:pt-16">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 sm:px-6 lg:flex-row">
          <div className="hidden w-full max-w-[260px] shrink-0 lg:flex lg:flex-col lg:gap-6 lg:pt-20">
            <div className="sticky top-28 space-y-6">
              <ProfileCard />
              <nav
                aria-label="Feed navigation"
                className="rounded-[16px] bg-white/85 p-4 shadow-sm backdrop-blur-sm"
              >
                ...
                <ul className="space-y-2 text-sm font-medium text-[var(--color-primary)]">
                  {QUICK_LINKS.map((item) => (
                    <li key={item.href}>
                      <Link
                        href={item.href}
                        className="flex items-center justify-between rounded-lg px-3 py-2 transition hover:bg-[var(--metallic-silver)]/60"
                      >
          ...
          <aside className="hidden w-full max-w-[280px] shrink-0 space-y-6 pt-20 xl:block">
            <div className="sticky top-28 space-y-6">
