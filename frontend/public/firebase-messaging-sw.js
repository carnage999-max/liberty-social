...
self.addEventListener("notificationclick", (event) => {
  ...
  // Handle notification action buttons (e.g., Answer/Decline for calls)
  ...
  if (action === "answer" || action === "reject") {
    ...
    event.waitUntil(
      self.clients
        ...
        .then((clientList) => {
          ...
          // If user clicked "answer", try to focus an existing window or open new one
          if (action === "answer") {
            const targetUrl = notificationData?.url || "/app/messages";
    ...
    const targetUrl = notificationData?.url || "/app/notifications";
