        ...
        <div className="flex items-center gap-3">
          <div className="flex-1 min-w-0">
            <button
              ...
              className="w-full rounded-full border border-gray-300 bg-white px-4 py-2.5 text-left text-sm text-gray-500 transition hover:bg-gray-50"
            >
              Share a post...
            </button>
          </div>
          <button
            type="button"
            onClick={() => setShowModal(true)}
            className="shrink-0 inline-flex items-center justify-center gap-2 rounded-full btn-primary px-4 py-2.5 text-sm font-semibold text-white transition hover:opacity-90"
            title="Create post"
          >
          ...
          <div className="w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-2xl rounded-none sm:rounded-3xl border border-(--color-border) bg-white shadow text-black flex flex-col overflow-hidden my-auto">
            ...
            <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6 border-b border-gray-200 shrink-0">
              ...
              <header className="flex-1 min-w-0">
                <h1 className="text-xl sm:text-2xl font-semibold text-black">Create Page Post</h1>
                <p className="text-xs sm:text-sm text-gray-600">Share an update with your followers.</p>
              </header>
            </div>
