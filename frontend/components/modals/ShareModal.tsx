...
export default function ShareModal({
  ...
  const shareLinks = {
    ...
    twitter: {
      ...
      icon: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.657l-5.207-6.807-5.966 6.807H2.882l7.701-8.828L2.288 2.25h6.876l4.7 6.216 5.378-6.216zM17.05 15.386l-.844-1.203L6.301 4.567h2.887l5.305 7.577.845 1.203 7.035 9.519h-2.887l-5.536-7.48z",
    },
    linkedin: {
      name: "LinkedIn",
