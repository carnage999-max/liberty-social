    ...
    <div className="rounded-2xl border border-gray-200 bg-white/90 p-5 shadow-sm space-y-4">
      ...
      <div>
        <input
          ...
          disabled={loading}
          className="w-full rounded-lg border bg-transparent px-3 py-2 text-sm placeholder-gray-900 border-(--color-gold) focus:outline-none focus:ring-1 focus:ring-[var(--color-primary)] text-black disabled:opacity-50"
        />
      </div>
